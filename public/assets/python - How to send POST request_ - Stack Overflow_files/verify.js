    ...
    try{
        ...
        var msg = {
            ...
            bsAdEntityInformation: {
                brandShieldId:'bd0ecb25ed3b44b1bab4a235062deea2',
        ...
        var findAndSendMessage = function() {
            if (!bst2tWin) {
                var frame = document.getElementById('bst2t_266624958848');
                if (frame) {
...
}, 10);var impId = 'bd0ecb25ed3b44b1bab4a235062deea2';var dvObj = $dvbs;var rtnName = dvObj==window.$dv ? 'ImpressionServed' : 'BeforeDecisionRender';dvObj.pubSub.subscribe(rtnName, impId, 'HE_RTN', function () { try {var ifu = '';var alu = 'http://ad.doubleclick.net/ddm/clk/291583327;106680815;k';var lbl='';var d=null,e=dvObj==window.$dv?parent:window,h=0,i=0,k=[],l=[],m=10;
...
if(""!=ifu){var z=p("iframe");z.src=ifu;e.document.body.insertBefore(z,d);o(z,64)};} catch (e) {}; });var uidbh='bd0ecb25ed3b44b1bab4a235062deea2'; $dvbs.pubSub.subscribe("BeforeDecisionRender",uidbh,"bh",function(){var a,b;"undefined"!==typeof $dv?(b=$dv,a="/event.gif"):"undefined"!==typeof $dvbs?(b=$dvbs,a="/bsevent.gif"):"undefined"!==typeof $dvbsr&&(b=$dvbsr,a="/bsevent.gif");var d=["dvp_brhl="+window.history.length],c=b.tags[uidbh];a=c.dv_protocol+"//"+(c.ServerPublicDns||c.serverPublicDns)+a+"?impid="+uidbh;c=[];if("undefined"!==typeof d)for(var e=0;e<d.length;e++)c.push(d[e]);a+="&"+c.join("&");b.domUtilities.addImage(a,b.tags[uidbh].tagElement.parentElement)});$dvbs.pubSub.subscribe("AfterDecisionRender",'bd0ecb25ed3b44b1bab4a235062deea2',"PerformanceCollector", 
                function() { 
                    try { 
                        if (typeof(_dv_win) == 'undefined' || typeof($dvbs) == 'undefined' || typeof($dvbs.tags) == 'undefined' || typeof($dvbs.tags['bd0ecb25ed3b44b1bab4a235062deea2']) == 'undefined' || typeof($dvbs.tags['bd0ecb25ed3b44b1bab4a235062deea2'].perf) == 'undefined') return; 
                        var perf = {}; 
                        for (var i = 0; i < $dvbs.tags['bd0ecb25ed3b44b1bab4a235062deea2'].perf.count; i++) { 
                            perf['dvp_r' + i] = $dvbs.tags['bd0ecb25ed3b44b1bab4a235062deea2'].perf['r' + i] 
                        } 

                        var guid = '266624958848'; 
                        ...
                        $dvbs.registerEventCall('bd0ecb25ed3b44b1bab4a235062deea2', perf, 0) 
                    } catch (e) {} 
                });(function() {var dvObj = $dvbs;var impId = 'bd0ecb25ed3b44b1bab4a235062deea2';dvObj.pubSub.subscribe(dvObj==window.$dv?"ImpressionServed":"BeforeDecisionRender",impId,"CTITS",function(){var a=-1;try{top.frames&&(a=top.frames.length),dvObj.registerEventCall(impId,{dvp_fcifrms:a})}catch(b){dvObj.registerEventCall(impId,{dvp_fcierr:b.message.slice(0,100)})}});})();(function() {var dvObj = $dvbs;var impId = 'bd0ecb25ed3b44b1bab4a235062deea2';var dvParams = {"mouseMvLogRate": "100","isDvp": "true","sampleInterval": "1","maxArrayLength": "10"};dvObj.pubSub.subscribe(dvObj==window.$dv?"ImpressionServed":"BeforeDecisionRender",impId,"CMPC", function() {function m(c,e,f){c.addEventListener?c.addEventListener(e,f,!1):c.attachEvent?c.attachEvent("on"+e,f,!1):c["on"+e]=f}function n(c,e,f){c.removeEventListener?c.removeEventListener(e,f):c.detachEvent?c.detachEvent("on"+e,f):c["on"+e]=null}function z(c,e){this.toString=function(){return"("+c+","+e+")"}} 
...
u);m(d,"mousemove",v);m(d,"mouseup",t);m(g,"mouseout",p);m(g,"touchmove",l);m(d,"unload",e);m(d,"beforeunload",e);var x=h.ea||5E4,C=h.fa||84E4;setTimeout(function(){e();c()},"object"===window.$dvbs||"object"===window.$dvbsr?x:C)}try{E()}catch(c){};});})();var dvObj = $dvbs;function np764531(g,i){function d(){function d(){function f(b,a){b=(i?"dvp_":"")+b;e[b]=a}var e={},a=function(b){for(var a=[],c=0;c<b.length;c+=2)a.push(String.fromCharCode(parseInt(b.charAt(c)+b.charAt(c+1),32)));return a.join("")},h=window[a("3e313m3937313k3f3i")];h&&(a=h[a("3g3c313k363f3i3d")],f("pltfrm",a));(function(){var a=e;e={};dvObj.registerEventCall(g,a,2E3,true)})()}try{d()}catch(f){}}try{dvObj.pubSub.subscribe(dvObj==window.$dv?"ImpressionServed":"BeforeDecisionRender",g,"np764531",d)}catch(f){}}
;np764531("bd0ecb25ed3b44b1bab4a235062deea2",false);


try{__tagObject_callback_266624958848({ImpressionID:"bd0ecb25ed3b44b1bab4a235062deea2", ServerPublicDns:"tps606.doubleverify.com"});}catch(e){}
try{$dvbs.pubSub.publish('BeforeDecisionRender', "bd0ecb25ed3b44b1bab4a235062deea2");}catch(e){}
try{__verify_callback_266624958848({
ResultID:2,
Passback:"",
AdWidth:300,
AdHeight:250});}catch(e){}
try{$dvbs.pubSub.publish('AfterDecisionRender', "bd0ecb25ed3b44b1bab4a235062deea2");}catch(e){}
